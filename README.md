...
* Есть ли отчёт по рабочему времени ?
  ...
  - Точный поминутный отчёт нам не нужен.
     Однако вы можете проксировать события входа и выхода по карточке на сторонний веб-сервер, передавая туда параметры, и там уже по этим событиям считать что вам надо. Или написать свой отчёт для анализа базы данных.
